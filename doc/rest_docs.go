...
func GenReST(cmd *zulu.Command, w io.Writer) error {
	return GenReSTCustom(cmd, w, defaultLinkHandler)
}

// GenReSTCustom creates custom reStructured Text output.
func GenReSTCustom(cmd *zulu.Command, w io.Writer, linkHandler func(string, string) string) error {
	...
	if !cmd.DisableAutoGenTag {
		buf.WriteString("*Auto generated by gowarden/zulu on " + time.Now().Format("2-Jan-2006") + "*\n")
	}
	_, err := buf.WriteTo(w)
	return err
}
...
func GenReSTTree(cmd *zulu.Command, dir string) error {
...
func GenReSTTreeCustom(cmd *zulu.Command, dir string, filePrepender func(string) string, linkHandler func(string, string) string) error {
