...
// current time if Date is unset and will use "Auto generated by gowarden/zulu"
...
func fillHeader(header *GenManHeader, name string, disableAutoGen bool) error {
	...
	if header.Source == "" && !disableAutoGen {
		header.Source = "Auto generated by gowarden/zulu"
	}
	return nil
}
...
func genMan(cmd *zulu.Command, header *GenManHeader) []byte {
	...
	if !cmd.DisableAutoGenTag {
		buf.WriteString(fmt.Sprintf("# HISTORY\n%s Auto generated by gowarden/zulu\n", header.Date.Format("2-Jan-2006")))
	}
	return buf.Bytes()
}
